...
cfg.training.batch_sizes = 64

cfg.stylegan2 = CN()
# Stylegan
cfg.stylegan2.d_repeats = 1
cfg.stylegan2.use_ema = True
cfg.stylegan2.ema = 20
cfg.stylegan2.style_mixing_prob = 0.0
...
cfg.model.G.mapping_kwargs.num_layers = 4
...
cfg.model.G.synthesis_kwargs.channel_base    = 32768 // 8    # Overall multiplier for the number of channels.
...
cfg.model.G.synthesis_kwargs.architecture = 'skip'
# ---------------------------------------------------------------------------- #
...
cfg.model.D.architecture        = 'orig' # Architecture: 'orig', 'skip', 'resnet'.
cfg.model.D.channel_base        = 32768 // 8    # Overall multiplier for the number of channels.
...
#Loss stylegan2
cfg.loss = CN()
cfg.loss.r1_gamma = 0.0002 * (cfg.dataset.resolution ** 2) / cfg.training.batch_sizes
cfg.loss.pl_decay = 0.01
cfg.loss.pl_weight = 2.0
cfg.loss.pl_batch_shrink = 2
